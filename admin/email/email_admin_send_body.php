                                                                                ...
                                                                                <table style="border-collapse: collapse;border-spacing: 0;width: 100%" width="100%">
                                                                                    <tbody><tr>
                                                                                            <td class="padded" style="padding: 0;vertical-align: top;padding-left: 40px;padding-right: 40px;word-break: break-word;word-wrap: break-word;text-align: left">
                                                                                                ...
                                                                                                <h1 style="Margin-top: 0;font-weight: normal;color: #3d88fd;font-family: sans-serif;font-size: 30px;Margin-bottom: 16px;line-height: 44px"><?php echo $title ?></h1><p style="Margin-top: 0;font-weight: 400;color: #fff;font-family: sans-serif;font-size: 14px;line-height: 22px;Margin-bottom: 20px">
                                                                                                    <?php
                                                                                                        echo $message_body;
                                                                                                    ?>
